	...
	public static void main(String[] args) {
		...
		glcanvas.addGLEventListener(new GLEventListener() {
			...
			public void reshape(GLAutoDrawable glautodrawable, int x, int y, int width, int height) {
				Assignment3.reshape(glautodrawable.getGL().getGL2(), width, height);
			}
			...
			public void init(GLAutoDrawable glautodrawable) {
				...
				shader[1] = CSCIx239.createShaderProg(gl, "model.vert", "proctex.frag");
			...
			public void display(GLAutoDrawable glautodrawable) {
				...
				Assignment3.display(glautodrawable.getGL().getGL2(), glautodrawable.getAnimator(), glautodrawable.getSurfaceWidth(), glautodrawable.getSurfaceHeight());
			}
		});
		...
		final Frame frame = new Frame("Performance - Jonathan Huang");
		frame.add(glcanvas);
