...
public class StringUtil {
	...
	public static final boolean isPrintableAscii(char c) {
		return c >= 0x20 && c <= 0x7E;
	}

	/**
	 * Removes characters outside the range of printable
	 * ASCII characters from the specified string.
	 * @param str
	 * @return
	 */
	public static final String filterPrintableAscii(String str) {
